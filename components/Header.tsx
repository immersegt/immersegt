        ...
        <section className="homeHeaderContainer">
            <Container size="xl" className="homeHeader">
                <div className="homeInfo">
                    ...
                    <span className="homeSubtitle2"><b><FaCalendarAlt /> April 5th-7th, 2025</b></span>
                    <span className="homeSubtitle2"><b><FaLocationDot /> Georgia Tech</b></span>
                    </div>
                    <p className="homeDescription">Participate in ImmerseGT, an innovative XR hackathon hosted by GTXR, on Georgia Tech's campus from April 5th-7th. Compete for your share of prizes as you build and test XR applications using state-of-the-art headsets.</p>

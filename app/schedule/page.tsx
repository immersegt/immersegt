    ...
    return (
        <div>
            ...
            <div className="scheduleContainer">
                <ScheduleItem title="Opening Ceremony" date="5:00PM" description="Join us for an interactive and engaging
                workshop with industry professionals where we will" save={true}/>
            </div>
